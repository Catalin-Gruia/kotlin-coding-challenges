...
private fun decapitalizeConst(str: String): String {
    // COPY-PASTE from the solution...I tried some implementations of mine, but they weren't as "beautiful" as the solution and I didn't want to end the weekend working on this :))
